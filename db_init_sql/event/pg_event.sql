...
-- ----------------------------
DROP
SEQUENCE IF EXISTS "public"."ideal_event_publish_temp_id_sequence";
CREATE
SEQUENCE "public"."ideal_event_publish_temp_id_sequence" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START
1 CACHE 1;
ALTER
SEQUENCE "public"."ideal_event_publish_temp_id_sequence" OWNER TO "postgres";
