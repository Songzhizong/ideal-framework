...
@ConditionalOnExpression("'${ideal.cache.memory-cache-type:CAFFEINE}'.equalsIgnoreCase('GUAVA')")
public class IdealBootGuavaCacheAutoConfigure implements BeanPostProcessor {

  @PostConstruct
  public void initSmartMemoryCacheBuilder() {
    log.info("SmartMemoryCacheBuilder.setMemoryCacheType(MemoryCacheType.GUAVA)");
    SmartMemoryCacheBuilder.setMemoryCacheType(MemoryCacheType.GUAVA);
  }
}
