...
public class IdealBootEventNoneTransactionAutoConfigure {


  @Bean("transactionalEventPublisher")
  public TransactionalEventPublisher transactionalEventPublisher(@Nonnull EventPublisher eventPublisher) {
    log.info("TransactionalEventPublisher is disabled, using EventPublisher");
