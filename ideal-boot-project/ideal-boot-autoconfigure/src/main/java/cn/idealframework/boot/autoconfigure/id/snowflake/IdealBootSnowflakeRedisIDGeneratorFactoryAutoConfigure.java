...
import cn.idealframework.id.snowflake.SpringRedisSnowFlakeFactory;
...
public class IdealBootSnowflakeRedisIDGeneratorFactoryAutoConfigure {
  ...
  public IDGeneratorFactory idGeneratorFactory(@Nonnull StringRedisTemplate stringRedisTemplate) {
    ...
    if (factoryType == IdealBootSnowflakeProperties.FactoryType.REDIS) {
