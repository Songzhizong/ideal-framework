...
@EnableConfigurationProperties(IdealBootOperationProperties.class)
@ConditionalOnClass({OperationLogAspect.class, OperationModule.class})
//@ConditionalOnProperty(prefix = IDEAL_BOOT_OPERATION_PREFIX, name = "enabled", havingValue = "true")
public class IdealBootOperationAutoConfigure {
