...
public final class StopStrategies {
  ...
  @Nonnull
  public static StopStrategy stopAfterDelay(@Nonnull Duration duration) {
    long millis = duration.toMillis();
    return stopAfterDelay(millis, TimeUnit.MILLISECONDS);
  }
  ...
  private static final class NeverStopStrategy implements StopStrategy {
    @Override
    public boolean shouldStop(@Nonnull Attempt<?> failedAttempt) {
      return false;
    }
  }
