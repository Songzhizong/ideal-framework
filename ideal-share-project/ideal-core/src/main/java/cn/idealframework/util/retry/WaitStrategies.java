...
public final class WaitStrategies {
   ...
   */
  @Nonnull
  public static WaitStrategy fixedWait(@Nonnull Duration duration) throws IllegalStateException {
    long millis = duration.toMillis();
    return new FixedWaitStrategy(millis);
  }
   ...
   * Returns a wait strategy that sleeps a fixed amount of time before retrying.
   *
   * @param sleepSeconds the time to sleep
   * @return a wait strategy that sleeps a fixed amount of time
   * @throws IllegalStateException if the sleep time is &lt; 0
   */
  @Nonnull
  public static WaitStrategy fixedWaitSeconds(int sleepSeconds) throws IllegalStateException {
    return fixedWait(sleepSeconds, TimeUnit.SECONDS);
  }
   ...
   */
  @Nonnull
  public static WaitStrategy fixedWaitMillis(int sleepMillis) throws IllegalStateException {
    return fixedWait(sleepMillis, TimeUnit.MILLISECONDS);
  }
   ...
   */
  @Nonnull
  public static WaitStrategy join(@Nonnull WaitStrategy... waitStrategies) {
  ...
  private static final class FixedWaitStrategy implements WaitStrategy {
    ...
    @Override
    public long computeSleepTime(@Nonnull Attempt<?> failedAttempt) {
      return sleepTime;
    }
  }
  ...
  private static final class CompositeWaitStrategy implements WaitStrategy {
    ...
    CompositeWaitStrategy(@Nonnull List<WaitStrategy> waitStrategies) {
  ...
  private static final class ExceptionWaitStrategy<T extends Throwable> implements WaitStrategy {
    ...
    @Override
    public long computeSleepTime(@Nonnull Attempt<?> lastAttempt) {
